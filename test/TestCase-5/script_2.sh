...
echo -e
sleep 3
java Main 5 1905 2001 4 buyer ${path1} ${path2} -Djava.rmi.server.codebase=file:${path3} &
echo -e
sleep 3
java Main 6 1906 2001 4 buyer ${path1} ${path2} -Djava.rmi.server.codebase=file:${path3} &
echo -e
sleep 3
java Controller ${path1}
#echo -e
#echo -e "Start Checking the Logs...!!"
